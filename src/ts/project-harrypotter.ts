...
// const showRipple = document.querySelectorAll(".hpfluidcontainer"),
// hideRipple = document.getElementsByClassName(".turbulence-filter");
...
function customRipple() {
    ...
    Flip.from(state, {
        ...
        // delay: 1.5,
        // onComplete: function() {
        //     // showRipple.setAttribute('class', 'show-filter');
